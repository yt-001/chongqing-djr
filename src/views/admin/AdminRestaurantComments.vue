  ...
  <div class="admin-comments">
    ...
    <el-card class="block" shadow="never">
      <el-form :inline="true" :model="query" class="search-form">
        ...
        <el-form-item label="餐饮ID">
          <el-input v-model="query.targetId" placeholder="餐饮ID" clearable style="width: 140px" />
        </el-form-item>
    ...
    <el-card class="block" shadow="never">
      <div class="table-wrap">
        <el-table :data="list" border style="width: 100%" v-loading="loading" @selection-change="onSelectionChange" @sort-change="onSortChange">
          ...
          <el-table-column prop="restaurantId" label="餐饮ID" width="120" />
...
import { fetchAdminRestaurantCommentsPage, updateAdminComment, deleteAdminComment } from '@/api'
...
function buildPagePayload() {
  ...
  if (query.targetId) q.restaurantId = Number(query.targetId)
...
async function loadData() {
  loading.value = true
  try {
    const data = await fetchAdminRestaurantCommentsPage(buildPagePayload())

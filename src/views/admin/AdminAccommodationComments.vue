  ...
  <div class="admin-comments">
    ...
    <el-card class="block" shadow="never">
      <el-form :inline="true" :model="query" class="search-form">
        ...
        <el-form-item label="住宿ID">
          <el-input v-model="query.targetId" placeholder="住宿ID" clearable style="width: 140px" />
        </el-form-item>
    ...
    <el-card class="block" shadow="never">
      <div class="table-wrap">
        <el-table :data="list" border style="width: 100%" v-loading="loading" @selection-change="onSelectionChange" @sort-change="onSortChange">
          ...
          <el-table-column prop="accommodationId" label="住宿ID" width="120" />
...
import { fetchAdminAccommodationCommentsPage, updateAdminComment, deleteAdminComment } from '@/api'
...
function buildPagePayload() {
  ...
  if (query.targetId) q.accommodationId = Number(query.targetId)
...
async function loadData() {
  loading.value = true
  try {
    const data = await fetchAdminAccommodationCommentsPage(buildPagePayload())

...
const IntangibleCulture = () => import('@/views/IntangibleCulture.vue')
const IntangibleCultureDetail = () => import('@/views/IntangibleCultureDetail.vue')
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/ai-assistant', name: 'ai-assistant', component: AiAssistant, meta: { title: '智能客服', hideTabbar: true } },
    ...
    { path: '/intangible-culture', name: 'intangible-culture', component: IntangibleCulture, meta: { title: '非遗文化', hideTabbar: true } },
    { path: '/intangible-culture/:id', name: 'intangible-culture-detail', component: IntangibleCultureDetail, meta: { title: '非遗文化详情', hideTabbar: true } },
    ...
    { path: '/admin', name: 'admin-home', component: () => import('@/views/admin/AdminHome.vue'), meta: { title: '管理员后台', hideTabbar: true },
      children: [
        { path: '', name: 'admin-default', redirect: { name: 'admin-attractions' } },
        ...
        { path: 'restaurant-dishes', name: 'admin-restaurant-dishes', component: () => import('@/views/admin/AdminRestaurantDishes.vue'), meta: { title: '菜品管理', hideTabbar: true } },
        { path: 'restaurant-categories', name: 'admin-restaurant-categories', component: () => import('@/views/admin/AdminRestaurantCategories.vue'), meta: { title: '分类管理', hideTabbar: true } },
        ...
        { path: 'comments/accommodations', name: 'admin-accommodation-comments', component: () => import('@/views/admin/AdminAccommodationComments.vue'), meta: { title: '住宿评论管理', hideTabbar: true } },
